//
//  FindPlaceImagePreviewScreen.swift
//  TrueScan
//
...
// Presentation/FindPlace/FindPlaceImagePreviewScreen.swift

import SwiftUI
import UIKit

struct FindPlaceImagePreviewScreen: View {
    let image: UIImage?
    let onAnalyse: (UIImage) -> Void
    let onBack: () -> Void

    // MARK: - Rotation / zoom / crop state (как в Cheater)
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 0) {
                CheaterHeader(title: "Place analysis", onBack: onBack)
                ...
                VStack(spacing: 16.scale) {
                    ...
                    Button {
                        ...
                        ZStack {
                            ...
                            .fill(image != nil ? Tokens.Color.accent : Color(hex: "#DC97AB"))
                            .shadow(
                                color: Color.black,
                                radius: 0,
                                x: 2,
...
// MARK: - Geometry helpers (как в Cheater)

private extension FindPlaceImagePreviewScreen {
